	...
	protected void onTargetSelected(HolyTome tome, Hero hero, Integer target) {
		...
		if (ally == Stasis.getStasisAlly()){
			...
			hero.sprite.parent.add(
					new Beam.SunRay(hero.sprite.center(), DungeonTilemap.raisedTileCenterToWorld(telePos), false));
			...
			hero.sprite.parent.add(
					new Beam.SunRay(ally.sprite.center(), DungeonTilemap.raisedTileCenterToWorld(telePos), false));
			Sample.INSTANCE.play( Assets.Sounds.RAY );
		}
