...
public class ChangesScene extends PixelScene {
	...
	public void create() {
        ...
        btn3_X.setRect(list.left()-4f, list.bottom(), 17, changesSelected == 0 ? 19 : 15);
        addToBack(btn3_X);
        ...
        btn2_X.setRect(btn3_X.right()-2, list.bottom(), 17, changesSelected == 1 ? 19 : 15);
        addToBack(btn2_X);
        ...
        btn1_X.setRect(btn2_X.right()-2, list.bottom(), 17, changesSelected == 2 ? 19 : 15);
        addToBack(btn1_X);
        ...
        btn0_9.setRect(btn1_X.right()-2, list.bottom(), 17, changesSelected == 3 ? 19 : 15);
        addToBack(btn0_9);
        ...
        btn0_8.setRect(btn0_9.right()-2, list.bottom(), 17, changesSelected == 4 ? 19 : 15);
        addToBack(btn0_8);
        ...
        btn0_7.setRect(btn0_8.right()-2, btn0_8.top(), 17, changesSelected == 5 ? 19 : 15);
        addToBack(btn0_7);
        ...
        btn0_6.setRect(btn0_7.right()-2, btn0_8.top(), 17, changesSelected == 6 ? 19 : 15);
        addToBack(btn0_6);
        ...
        btnOld.setRect(btn0_6.right()-2, btn0_8.top(), 19, changesSelected == 7 ? 19 : 15);
        addToBack(btnOld);

        StyledButton btnMod = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "MOD", 8){
            @Override
            protected void onClick() {
                super.onClick();
        ...
        if (changesSelected != 8) btnMod.textColor( 0xBBBBBB );
        btnMod.setRect(btnOld.right()-2, btnOld.top(), 23, changesSelected == 8 ? 19 : 15);
        addToBack(btnMod);
