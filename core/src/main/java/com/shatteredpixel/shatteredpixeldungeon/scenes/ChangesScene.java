...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		list.setRect(
				...
				panel.innerHeight() + 2);
		list.scrollTo(0, 0);
        StyledButton btn3_X = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "Matt Edition", 8){
            @Override
        ...
        StyledButton btn2_X = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "Shattered PD", 8){
            @Override
            protected void onClick() {
                super.onClick();
        ...
        float tabW = (panel.width() + 4) / 2f;

        btn3_X.setRect(
                panel.x - 2,
                list.bottom(),
                tabW,
                changesSelected == 0 ? 19 : 15
        );
