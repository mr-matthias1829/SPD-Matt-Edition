...
public class SpiritBow extends Weapon {
    ...
    public int damageRoll(Char owner) {
        ...
        if (sniperSpecial){
            ...
            } else if (augment instanceof SpeedAugment) {
    ...
    protected float baseDelay(Char owner) {
        if (sniperSpecial){
            if (augment instanceof SpeedAugment) {
                ...
                // NoWeaponAugment or any other augment: snapshot behaviour
                return 0f;
            }
        } else {
    ...
    public class SpiritArrow extends MissileWeapon {
        ...
        public float accuracyFactor(Char owner, Char target) {
            if (sniperSpecial && SpiritBow.this.augment instanceof DamageAugment){
        ...
        protected void onThrow( int cell ) {
            ...
            if (enemy == null || enemy == curUser) {
                ...
                if (sniperSpecial && !(SpiritBow.this.augment instanceof SpeedAugment)) sniperSpecial = false;
            }
        }
        ...
        public void cast(final Hero user, final int dst) {
            ...
            if (sniperSpecial && SpiritBow.this.augment instanceof SpeedAugment){
