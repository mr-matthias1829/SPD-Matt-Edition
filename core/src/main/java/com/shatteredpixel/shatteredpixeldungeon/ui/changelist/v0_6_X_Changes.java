...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( ChangeIcons.V022_WEIGHTSTONE, "Stone of Augmentation",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V065_CLOTH_CURSED, "New Curses",
				"Added 4 new curses:\n\n" +
		...
		changes.addButton( new ChangeButton( ChangeIcons.V065_BADGE_CHAMPION, "New and Changed Badges",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V040_STYLUS, "Glyph Changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V065_SWORD_LUCKY, "Lucky Enchantment",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_MAGE_HEROARM, "Warlock",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_HUNTRESS_CLOTH, "Huntress",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V065_SHORTSWORD_CURSED, "Wayward curse",
		...
		changes.addButton( new ChangeButton( ChangeIcons.PD_SKELETON, "Skeletons",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V065_ARMOR_KIT, "Rogue Garb and Huntress Cloak",
	...
	public static void add_v0_6_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( ChangeIcons.V064_CHALLENGES, "Challenges",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V064_INFO, "Start game UI",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V064_CROSSBOW, "New Weapons",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V064_HOLSTER, "Inventory changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V023_HOURGLASS, "Timekeeper's Hourglass",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V064_TALISMAN, "Talisman of Foresight",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V064_PARALYSIS, "Paralysis changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V064_CHASM, "Chasm changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V064_SEED_SUNGRASS, "Seed adjustments",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V023_POTION_CRIMSON, "Potion of Healing",
	...
	public static void add_v0_6_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_TRIDENT, "Ranged Weapons Overhaul!",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_DART_ICECAP, "Expanded Alchemy",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_RING_TOPAZ, "Ring of Sharpshooting",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_BUFFS_BURNING, "Changes to debuffs and resistances",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_CORROSION, "Wand of Corrosion",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_RING_EMERALD, "Ring of Elements",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_MAGICMISSILE, "Minor Wand buffs",
				"Wand of Corruption:\n" +
		...
		changes.addButton( new ChangeButton( ChangeIcons.V043_FLAIL, "Weapon and Glyph buffs",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_RING_ONYX, "Ring of Evasion",
	...
	public static void add_v0_6_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_STAIRS, "Dungeon Secrets!",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_ROGUE_CLOTH, "Rogue Rework!",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_ROGUE_HEROARM, "Rogue Subclasses Rework!",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_FIRE_TRAP, "Trap Overhaul!",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_GOLD_CHEST, "Chest Adjustments",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_IRON_KEY, "New Key Display",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_STATUE, "AI and Enemy Changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_DAGGER, "Sneak Attack Weapons",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V043_FLAIL, "Flail",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_POTION_GOLDEN, "Potion Adjustments",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_REMAINS, "Heroes Remains",
	...
	public static void add_v0_6_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_PAGE, "Journal Additions",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_BADGE, "Badge Changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V020_RING_DIAMOND, "Ring Mechanics Changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_DEW_VIAL, "Dew Vial",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_STATUE, "AI Changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_INVENTORY, "Inventory",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V020_HORN, "Horn of Plenty",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_RING_GARNET, "Ring of Might",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_ETHEREAL_CHAINS, "Ethereal Chains",
	...
	public static void add_v0_6_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(ChangeIcons.V050_STAIRS, "Levelgen Overhaul!",
		...
		changes.addButton( new ChangeButton(ChangeIcons.V060_TORCH, "Light Source Buffs",
		...
		changes.addButton( new ChangeButton(ChangeIcons.V060_RATION, "Food Buffs",
				"_-_ Meat and small rations are 50% more filling\n" +
				"_-_ Pasties and blandfruit are 12.5% more filling"));
		
		changes.addButton( new ChangeButton(ChangeIcons.V060_GREATAXE, "Tier-5 Weapon Buffs",
				"_-_ Greataxe base damage increased by ~22%\n" +
				"_-_ Greatshield base damage increased by ~17%"));
		
		changes.addButton( new ChangeButton(ChangeIcons.V040_STYLUS, "Enchant and Glyph Balance Changes",
