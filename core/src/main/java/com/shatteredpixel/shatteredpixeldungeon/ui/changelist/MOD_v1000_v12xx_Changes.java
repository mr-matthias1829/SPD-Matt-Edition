...
public class MOD_v1000_v12xx_Changes {
    ...
    public static void addAllChanges(ArrayList<ChangeInfo> list){
        ...
        list.add(new ChangeInfo("v1264: everyone starts as nobody", true,
                "HERO:\n"
        ...
        list.add(new ChangeInfo("v1261: 1 line changed, literally", true,
                "MECHANIC CHANGES:\n"
                        + "1. challenges SHOULD be unlocked by default now, no longer requiring a win to be unlocked"));

        list.add(new ChangeInfo("v1260: final changes (hopefully)", true,
                "ENEMIES:\n"
        ...
        list.add(new ChangeInfo("v1256: error fixes", true,
                "FIXES:\n"
        ...
        list.add(new ChangeInfo("v1254: weaker tanks & gear", true,
                "ENEMIES:\n"
        ...
        list.add(new ChangeInfo("v1252: fixes & balancing", true,
                "VANITY:\n"
        ...
        list.add(new ChangeInfo("v1249: massive bug fix", true,
                "FIXES:\n"
        ...
        list.add(new ChangeInfo("v1245: magical armor", true,
                "NEW CONTENT:\n"
        ...
        list.add(new ChangeInfo("v1242: weaker quest rewards", true,
                "CHANGES:\n"
        ...
        list.add(new ChangeInfo("V1.232: a little extra", true,
                "NEW CONTENT:\n"
        ...
        list.add(new ChangeInfo("v1.233: first 'unpublic' release", true,
                "CHANGES:\n"
                        + "1. setup a actual github repository\n"
                        + "2. created first usable release\n"
                        + "3. i am in active pain"));

        list.add(new ChangeInfo("v1.23: cheating no more", true,
                "CHANGES:\n"
        ...
        list.add(new ChangeInfo("v1.22: mod != SPD", true,
                "CHANGES:\n"
                        + "1. the modded version no longer shares data with vanilla SPD\n"
                        + "2. changed app icon"));

        list.add(new ChangeInfo("v1.21: IS IT HARD ENOUGH?!", true,
                "NEW CONTENT:\n"
        ...
        list.add(new ChangeInfo("v1.2: clean-up & variants", true,
                "ENEMIES:\n"
        ...
        list.add(new ChangeInfo("v1.145: all about vanity", true,
                "ROOMS:\n"
        ...
        list.add(new ChangeInfo("v1.14: stronger tengu & jails", true,
                "ENEMIES:\n"
        ...
        list.add(new ChangeInfo("v1.13: stronger goo", true,
                "NEW CONTENT:\n"
        ...
        list.add(new ChangeInfo("v1.12: toned down enemies", true,
                "ENEMIES:\n"
        ...
        list.add(new ChangeInfo("v1.11: less luck, better resources", true,
                "ITEMS:\n"
        ...
        list.add(new ChangeInfo("v1.1: less luck, more skill", true,
                "ITEMS:\n"
        ...
        list.add(new ChangeInfo("V1: cursed nightmare", true,
                "ITEMS:\n"
